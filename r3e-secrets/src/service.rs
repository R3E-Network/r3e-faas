...
impl SecretService for SecretServiceImpl {
    ...
    async fn get_secret(
        ...
        let secret = self.storage.get_secret(user_id, function_id, secret_id).await?;
    ...
    async fn delete_secret(
        ...
        self.storage.delete_secret(user_id, function_id, secret_id).await
    }
    ...
    async fn list_secret_ids(
        ...
        let secrets = self.storage.list_function_secrets(user_id, function_id).await?;
