import { WalletConnectWalletAdapter, } from '@rentfuse-labs/neo-wallet-adapter-walletconnect';
import { WalletName } from './types';
export const getWalletConnectWallet = (config) => ({
...
export const getNeonWalletConnectWallet = (config) => ({
