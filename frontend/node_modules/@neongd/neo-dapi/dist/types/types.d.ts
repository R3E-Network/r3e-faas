...
export declare type SignerScope = 'None' | 'CalledByEntry' | 'CustomContracts' | 'CustomGroups' | 'Global' | 'WitnessRules';
export declare type WitnessRuleAction = 'Deny' | 'Allow';
...
export declare type OracleResponseCode = 'Success' | 'ProtocolNotSupported' | 'ConsensusUnreachable' | 'NotFound' | 'Timeout' | 'Forbidden' | 'ResponseTooLarge' | 'InsufficientFunds' | 'ContentTypeNotSupported' | 'Error';
...
export declare type Attribute = HighPriorityAttribute | OracleResponseAttribute;
