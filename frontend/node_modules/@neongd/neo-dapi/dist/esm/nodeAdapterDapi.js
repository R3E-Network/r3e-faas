...
import { BaseJsonRpcTransport, formatErrorResponse, getStandardErrorResponse, RpcError, StandardErrorCodes, } from '@neongd/json-rpc';
import { DapiErrorCodes, getDapiErrorResponse } from '.';
export class NodeAdapterDapi {
    ...
    invokeReadMulti(params) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const script = sc.createScript(...params.invocations.map(invocation => {
                var _a;
                return (Object.assign(Object.assign({}, invocation), { args: (_a = invocation.args) === null || _a === void 0 ? void 0 : _a.map(arg => sc.ContractParam.fromJson(arg)) }));
            }));
    ...
    convertRemoteRpcError(error) {
        throw new RpcError(Object.assign(Object.assign({}, getDapiErrorResponse(DapiErrorCodes.RemoteRpcError)), { data: formatErrorResponse(error) }));
    }
}
