...
export declare type JsonRpcPayload<RP = any, NP = any, R = any> = JsonRpcRequest<RP> | JsonRpcNotification<NP> | JsonRpcResponse<R>;
...
export declare type PostMessage = (message: string) => void;
export declare type MessageListener = (message: string) => void;
export declare type Disposer = () => void;
export declare type AddMessageListener = (listener: MessageListener) => Disposer | void;
