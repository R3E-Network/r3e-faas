...
impl FunctionDeploymentService {
    ...
    pub async fn deploy_function(
        ...
        let sandbox_config = self.sandbox_manager.create_config_for_security_level(&security_level);
    ...
    pub async fn undeploy_function(&self, id: &str) -> Result<(), String> {
        ...
        match deployment_index {
            ...
            None => {
                Err(format!("Function deployment not found: {}", id))
            }
        }
    }
    ...
    pub async fn invoke_function(
        ...
        let mut result = FunctionInvocationResult::new(
            id.to_string(),
            user_id.to_string(),
            input.clone(),
        );
        ...
        // Get the sandbox configuration for the security level
        let sandbox_config = self.sandbox_manager.create_config_for_security_level(&deployment.security_level);
