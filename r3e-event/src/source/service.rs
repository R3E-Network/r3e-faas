...
pub mod task_source_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::AcquireTaskOutput>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/service.TaskSource/AcquireTask");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("service.TaskSource", "AcquireTask"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn acquire_func(
            &mut self,
            request: impl tonic::IntoRequest<super::AcquireFuncInput>,
        ) -> std::result::Result<tonic::Response<super::AcquireFuncOutput>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/service.TaskSource/AcquireFunc");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("service.TaskSource", "AcquireFunc"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod task_source_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with TaskSourceServer.
    #[async_trait]
    pub trait TaskSource: std::marker::Send + std::marker::Sync + 'static {
        async fn acquire_task(
            &self,
            request: tonic::Request<super::AcquireTaskInput>,
        ) -> std::result::Result<tonic::Response<super::AcquireTaskOutput>, tonic::Status>;
        async fn acquire_func(
            &self,
            request: tonic::Request<super::AcquireFuncInput>,
        ) -> std::result::Result<tonic::Response<super::AcquireFuncOutput>, tonic::Status>;
    }
    #[derive(Debug)]
    pub struct TaskSourceServer<T> {
        inner: Arc<T>,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/service.TaskSource/AcquireTask" => {
                    ...
                    impl<T: TaskSource> tonic::server::UnaryService<super::AcquireTaskInput> for AcquireTaskSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as TaskSource>::acquire_task(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/service.TaskSource/AcquireFunc" => {
                    ...
                    impl<T: TaskSource> tonic::server::UnaryService<super::AcquireFuncInput> for AcquireFuncSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TaskSource>::acquire_func(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for TaskSourceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "service.TaskSource";
    impl<T> tonic::server::NamedService for TaskSourceServer<T> {
