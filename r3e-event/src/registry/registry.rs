...
impl TriggerType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Blockchain => "TRIGGER_TYPE_BLOCKCHAIN",
            Self::Schedule => "TRIGGER_TYPE_SCHEDULE",
            Self::Http => "TRIGGER_TYPE_HTTP",
            Self::Oracle => "TRIGGER_TYPE_ORACLE",
        }
    }
...
pub mod function_registry_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("registry.FunctionRegistry", "RegisterFunction"),
                );
        ...
        pub async fn update_function(
            ...
            tonic::Response<super::UpdateFunctionResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("registry.FunctionRegistry", "UpdateFunction"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("registry.FunctionRegistry", "GetFunction"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("registry.FunctionRegistry", "ListFunctions"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn delete_function(
            ...
            tonic::Response<super::DeleteFunctionResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("registry.FunctionRegistry", "DeleteFunction"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod function_registry_server {
                ...
                "/registry.FunctionRegistry/RegisterFunction" => {
                    ...
                    for RegisterFunctionSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as FunctionRegistry>::register_function(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/registry.FunctionRegistry/UpdateFunction" => {
                    ...
                    for UpdateFunctionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FunctionRegistry>::update_function(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/registry.FunctionRegistry/GetFunction" => {
                    ...
                    for GetFunctionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FunctionRegistry>::get_function(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/registry.FunctionRegistry/DeleteFunction" => {
                    ...
                    for DeleteFunctionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FunctionRegistry>::delete_function(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "registry.FunctionRegistry";
