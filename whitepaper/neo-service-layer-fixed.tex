...
% TikZ libraries
\usetikzlibrary{shapes,arrows,positioning,fit,calc,backgrounds,decorations.pathreplacing,shapes.geometric,shapes.misc,shadows}

% Define TikZ styles used across figures
\tikzset{
    ...
    entity/.style={rectangle, draw, fill=green!20, text width=8em, text centered, rounded corners, minimum height=3em},
    note/.style={font=\small\itshape, midway},
    cloud/.style={draw, ellipse, fill=red!20, node distance=3cm, minimum height=2em},
    % Define arrow-text style for consistent text positioning
    arrow-text/.style={font=\footnotesize, text width=2.5cm, align=center},
    above-arrow-text/.style={above, arrow-text},
    below-arrow-text/.style={below, arrow-text},
    modern-box/.style={
      rectangle, 
      rounded corners=3pt, 
      draw=gray!60, 
    ...
    primary-color/.style={fill=blue!10},
    secondary-color/.style={fill=teal!10},
    tertiary-color/.style={fill=orange!10},
    highlight-color/.style={fill=red!10},
    neutral-color/.style={fill=gray!10}
}

% Enhanced Figure Styling for Better Visual Appearance
\tikzset{
  % Modern node styles
  modern-box/.style={
    rectangle, 
  ...
  % Dashed arrow style for feedback/response flows
  modern-dashed/.style={
    modern-arrow,
    dashed
  },
  
  % Nicer text styling for annotations
  modern-text/.style={
    font=\small,
    text width=2.5cm,
    align=center,
...
% Algorithm formatting - using etoolbox to set font size
...
% Global TikZ settings - consistent styling
\tikzset{
  box/.style={
    rectangle, 
    draw, 
  ...
  % Arrow text styles for consistent text appearance and positioning
  arrow-text/.style={
    font=\footnotesize,
    text width=2.5cm,
    align=center
  },
  above-arrow-text/.style={
    above,
    arrow-text
  },
  below-arrow-text/.style={
    below,
    arrow-text
  }
}
...
\newcommand{\companylogo}{%
  \begin{tikzpicture}
    \node[rectangle, draw, minimum width=3cm, minimum height=1.5cm, fill=blue!10] {R3E};
  \end{tikzpicture}%
}
...
\input{figures/neo-service-layer/oracle-elegant}
...
\input{figures/neo-service-layer/tee-elegant}
...
% Include the crypto relationships diagram
\input{figures/neo-service-layer/crypto-relationships-elegant}
