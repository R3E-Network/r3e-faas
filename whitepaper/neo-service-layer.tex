...
\input{figures/neo-service-layer/gas_bank}
...
\input{figures/neo-service-layer/gas_bank_protocol}
...
\input{figures/neo-service-layer/meta_tx_protocol}
...
\input{figures/neo-service-layer/price_feed_protocol}
...
\input{figures/neo-service-layer/event_protocol}
...
\input{figures/neo-service-layer/function_protocol}

\input{figures/neo-service-layer/function_execution}
...
\input{figures/neo-service-layer/secret_protocol}
...
\input{figures/neo-service-layer/sandbox_protocol}
...
\input{figures/neo-service-layer/smart_contract_protocol}
...
\input{figures/neo-service-layer/advanced_crypto_protocol}
