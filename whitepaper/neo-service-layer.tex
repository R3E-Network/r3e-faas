...
\newenvironment{algorithmic}[1][]
  {\begin{quote}\begin{itemize}[leftmargin=*]}
...
\input{figures/gas_bank_operations}
...
\input{figures/gas_bank_protocol}
...
\input{figures/meta_tx_protocol}
...
\input{figures/price_feed_protocol}
...
\input{figures/function_deployment}
...
\input{figures/function_protocol}

\input{figures/function_execution}
...
\input{figures/sandbox_protocol}
...
\input{figures/smart_contract_protocol}
...
\input{figures/advanced_crypto_protocol}
...
\input{figures/abstract_account}
