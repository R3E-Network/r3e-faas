...
% Arrows
\draw[arrow] (contract) -- node[above-arrow-text, left] {1. Request} (tee);
\draw[dashed_arrow] (tee) -- node[above-arrow-text, right] {4. Verified Result} (contract);

\draw[arrow] (tee) -- node[above-arrow-text, left] {2. Execute} (sgx);
\draw[arrow] (tee) -- (sev);
\draw[arrow] (tee) -- (trustzone);
\draw[arrow] (tee) -- (nitro);
\draw[arrow] (tee) -- node[above-arrow-text, right] {2. Execute} (cloud);
...
\draw[dashed_arrow] (computation) -- node[above-arrow-text, right] {3. Attestation} (tee);
