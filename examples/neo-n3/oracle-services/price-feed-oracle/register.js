/**
 * Registration script for Neo N3 Price Feed Oracle
 * 
 * This script registers the price feed oracle function with the Neo N3 FaaS platform.
 */
...
async function registerFunction() {
  try {
    ...
    console.log('Registering price feed oracle function with Neo N3 FaaS platform...');
    ...
    if (response.status === 201) {
      ...
      // Display information about the oracle configuration
      console.log('\nOracle Configuration:');
      
      console.log('Supported Asset Pairs:');
      config.oracle.pairs.forEach(pair => {
        console.log(`- ${pair}`);
      });
      ...
      console.log('\nAggregation Method:', config.oracle.aggregation.method);
      console.log('Minimum Sources Required:', config.oracle.aggregation.min_sources);
      ...
      console.log('\nThe price feed oracle function is now registered and will start providing price data according to the configured schedule.');
    } else {
